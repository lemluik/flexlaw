...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'Да, иностранные граждане и компании могут регистрировать бизнес в КР наравне с резидентами. Для регистрации ОсОО достаточно паспорта (с нотариальным переводом) и ИНН страны гражданства. Мы сопровождаем весь процесс «под ключ».',
  },
  {
  ...
  },
  {
    ...
    answer: 'Процесс занимает от 3 до 6 месяцев. Требуется подготовить бизнес-план, документы о соответствии, пройти проверку Нацбанка. Мы сопровождаем полный цикл: от подготовки документов до получения лицензии. Стоимость — по запросу, зависит от сложности проекта.',
  },
  {
    question: 'Нужно ли личное присутствие для регистрации бизнеса?',
    answer: 'Для регистрации компании личное присутствие не обязательно — мы можем действовать по доверенности. Однако для открытия банковского счёта банки обычно требуют личного визита руководителя. Мы организуем встречу в удобное время.',
  },
  {
    question: 'Какая налоговая система в Кыргызстане для бизнеса?',
    answer: 'Для юридических лиц доступны несколько режимов: общая система (налог на прибыль 10%, НДС 12%), патентная система, упрощённая система для малых предприятий. Выбор зависит от вида деятельности и оборота. Мы консультируем по выбору оптимального режима.',
  },
  {
